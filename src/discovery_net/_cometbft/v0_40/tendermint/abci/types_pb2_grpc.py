...
from discovery_net._cometbft.v0_40.tendermint.abci import (
...
class ABCIStub:
    ...
    def __init__(self, channel):
        ...
        self.CheckTx = channel.unary_unary(
                ...
                _registered_method=True)
        self.InsertTx = channel.unary_unary(
                '/tendermint.abci.ABCI/InsertTx',
                request_serializer=tendermint_dot_abci_dot_types__pb2.RequestInsertTx.SerializeToString,
                response_deserializer=tendermint_dot_abci_dot_types__pb2.ResponseInsertTx.FromString,
                _registered_method=True)
        self.ReapTxs = channel.unary_unary(
                '/tendermint.abci.ABCI/ReapTxs',
                request_serializer=tendermint_dot_abci_dot_types__pb2.RequestReapTxs.SerializeToString,
                response_deserializer=tendermint_dot_abci_dot_types__pb2.ResponseReapTxs.FromString,
                _registered_method=True)
...
def add_ABCIServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'InsertTx': grpc.unary_unary_rpc_method_handler(
                    servicer.InsertTx,
                    request_deserializer=tendermint_dot_abci_dot_types__pb2.RequestInsertTx.FromString,
                    response_serializer=tendermint_dot_abci_dot_types__pb2.ResponseInsertTx.SerializeToString,
            ),
            'ReapTxs': grpc.unary_unary_rpc_method_handler(
                    servicer.ReapTxs,
                    request_deserializer=tendermint_dot_abci_dot_types__pb2.RequestReapTxs.FromString,
                    response_serializer=tendermint_dot_abci_dot_types__pb2.ResponseReapTxs.SerializeToString,
            ),
...
class ABCI:
    ...
    def InsertTx(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/tendermint.abci.ABCI/InsertTx',
            tendermint_dot_abci_dot_types__pb2.RequestInsertTx.SerializeToString,
            tendermint_dot_abci_dot_types__pb2.ResponseInsertTx.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def ReapTxs(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/tendermint.abci.ABCI/ReapTxs',
            tendermint_dot_abci_dot_types__pb2.RequestReapTxs.SerializeToString,
            tendermint_dot_abci_dot_types__pb2.ResponseReapTxs.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
